...
from path_optimization_system import create_graph, find_shortest_path, find_shortest_path_no_traffic, find_shortest_path_in_traffic_no_toll, find_shortest_path_restricted
import unittest
...
class Internalpath_optimization_systemTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.m = RoadMap()
        cls.na = Node('NA')
    ...
    # ------------------------------------------------ testing path_optimization_system.py
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(Internalpath_optimization_systemTest)
